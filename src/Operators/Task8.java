...
public class Task8 {
    ...
    public static String moneyСonversion(int money) {
        String moneyString;
        if (money == 11 || money == 12 || money == 13 || money == 14 || money % 10 == 0 || money % 10 == 6 || money % 10 == 7 || money % 10 == 8 || money % 10 == 9|| money % 10 == 5 || money % 100 == 11|| money % 100 == 12|| money % 100 == 13|| money % 100 == 14){
            moneyString = " Рублей";
        } else if (money % 10 == 1) {
            moneyString = " Рубль";
        } else {
